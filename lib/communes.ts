...
export const TOP_COMMUNES: TopCommune[] = [
  ...
  { code: "30189", name: "Nîmes", lat: 43.8367, lon: 4.3601 },
  { code: "63113", name: "Clermont-Ferrand", lat: 45.7772, lon: 3.087 },
  { code: "42218", name: "Saint-Étienne", lat: 45.4397, lon: 4.3872 },
  { code: "37261", name: "Tours", lat: 47.3941, lon: 0.6848 },
  { code: "59009", name: "Villeneuve-d'Ascq", lat: 50.6202, lon: 3.1471 },
  { code: "14118", name: "Caen", lat: 49.1829, lon: -0.3707 },
  { code: "45234", name: "Orléans", lat: 47.9029, lon: 1.9039 },
  { code: "97209", name: "Fort-de-France", lat: 14.6037, lon: -61.0738 },
  { code: "97120", name: "Pointe-à-Pitre", lat: 16.2418, lon: -61.5341 },
  ...
  { code: "25056", name: "Besançon", lat: 47.2378, lon: 6.0241 },
